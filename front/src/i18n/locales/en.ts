export default {
  ...
  combat: {
    ...
    actions: {
      ...
      aim: 'Aim',
      aimDesc: 'Reroll 1d20 on the next attack test you make during this turn',
      move: 'Move',
    ...
    activeTurn: {
      ...
      skipNormalActions: 'This combatant is dazed: normal actions lost this turn. They can still spend AP.',
    },
    dying: {
      title: 'Dying',
      injuries: 'Active injuries',
      tn: 'TN (Endurance + Survival)',
      difficulty: 'Difficulty',
      complicationRange: 'Complication',
      roll: 'Roll survival test',
      apply: 'Apply result',
      successes: 'Successes',
      survived: 'Stays alive (still dying)',
      died: 'Dies',
      complication: 'Complication! Narrate an aggravation.',
      stabilize: 'Stabilize (Medicine)',
      noHeal: 'Dying: no normal heal. Use "Stabilize".',
      injuriesShort: 'injuries',
    },
    injury: {
    ...
    attackFlow: {
      ...
      rollApp: 'Roll in app',
      manual: 'Manual input',
      computePreview: 'Compute preview',
      resolve: 'Resolve and apply',
      undo: 'Undo last attack',
      raw: 'Raw',
      dr: 'DR',
      final: 'Final',
      injuryTriggered: 'Critical hit ≥5 dmg: injury triggered',
