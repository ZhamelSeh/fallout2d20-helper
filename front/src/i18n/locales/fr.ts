export default {
  ...
  combat: {
    ...
    actions: {
      ...
      aim: 'Viser',
      aimDesc: 'Relancez 1d20 sur le prochain test d\'attaque que vous effectuez au cours du tour',
      move: 'Se déplacer',
    ...
    activeTurn: {
      ...
      skipNormalActions: 'Ce combattant est hébété : actions normales perdues ce tour. Il peut toujours dépenser des PA.',
    },
    dying: {
      title: 'Mourant',
