...
export const weapons: Weapon[] = [
  ...
  {
    name: 'Laserotron Head Laser',
    value: 115, rarity: 4, weight: 4,
    skill: 'energyWeapons',
    damage: 5, damageType: 'energy', fireRate: 0, range: 'close',
    qualities: [{ quality: 'piercing', value: 1 }],
    ammo: 'fusionCell', ammoPerShot: 2,
  },
  {
    name: 'Medusatron',
    value: 120, rarity: 4, weight: 1,
    skill: 'energyWeapons',
  ...
  {
    name: 'Construction Pincer',
    value: 25, rarity: 0, weight: 1.5,
    skill: 'unarmed',
